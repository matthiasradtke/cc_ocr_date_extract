...
# cc_ocr_date_extract documentation build
...
from cc_ocr_date_extract import __version__ as release

# -- Project information -----------------------------------------------------

project = "cc_ocr_date_extract"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "cc_ocr_date_extractdoc"
...
latex_documents = [
    (
        master_doc,
        "cc_ocr_date_extract.tex",
        "cc_ocr_date_extract Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "cc_ocr_date_extract",
        "Project cc_ocr_date_extract codebase.",
        "Data-Science",
    )
]
